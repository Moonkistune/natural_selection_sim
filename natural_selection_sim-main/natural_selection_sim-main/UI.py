...
class Button():
    def __init__(self, x, y):
        ...
        self.x = x
        self.y = y
        self.image = pygame.transform.scale(pygame.image.load("natural_selection_sim-main/assets/start_button_troll.png"), (constantes.LARGEUR_BOUTON, constantes.HAUTEUR_BOUTON))
...
def ecran_vierge(fenetre):
    ...
    surface_general.fill("black")  # couleur black
    surface_stats.fill((0, 133, 31))  # couleur verte
    surface_settings.fill("blue")  # couleur bleu

    # Button.Afficher(surface_settings)
    image = pygame.transform.scale(pygame.image.load("natural_selection_sim-main/assets/start_button_troll.png"), (constantes.LARGEUR_BOUTON, constantes.HAUTEUR_BOUTON))
